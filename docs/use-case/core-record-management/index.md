...
summary: >-
  Core record management maintains fundamental customer information including addresses, legal entities, locations, buildings, countries, jurisdictions, regions, and audit trails. This use case provides the foundational data structures for Client 360 and KYC processes, sharing concepts with Legal Entity Management but viewed from a customer perspective, and enabling geographic reference data and jurisdictional compliance across the customer lifecycle.
keywords:
  - core
  - record
  - management
...
Some concepts overlap with Legal Entity Management but are viewed from
