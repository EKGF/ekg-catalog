...
GDPR (General Data Protection Regulation) compliance in KYC involves managing customer data in accordance with EU data protection regulations, including data subject rights, consent management, data minimization, and the right to be forgotten. By creating a holistic view of data within the organization and leveraging both internally and externally available data (such as directors, shareholders, sanctions and adverse lists), the EKG can create a holistic view and analyze current and potential clients, enabling the identification of direct and indirect (i.e. beneficial ownership structures) risk factors while maintaining GDPR compliance.
