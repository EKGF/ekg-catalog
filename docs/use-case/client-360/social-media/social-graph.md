...
<object data="../../../../diagrams/out/social-graph.svg#darkable" type="image/svg+xml"></object>
...
The Social Graph focuses on **who knows whom** — the relationships between people. The [Interest Graph](interest-graph.md) focuses on **what people care about** — the relationships between people and topics, brands, and content. Both are complementary views that together provide a complete picture of social media dynamics.
