...
<object data="../../../../diagrams/out/political-connections.svg#darkable" type="image/svg+xml"></object>

## Summary

Political Connections identify relationships between customers and politically exposed persons (PEPs), government officials, political organizations, and public institutions. Understanding these connections is critical for regulatory compliance, risk management, and avoiding reputational damage from corruption or money laundering.
...
See also [Politically Exposed Persons (PEPs)](../know-your-customer/peps.md) for more detailed PEP screening processes.
