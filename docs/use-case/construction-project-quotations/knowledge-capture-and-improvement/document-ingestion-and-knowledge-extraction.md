...
queried, validated, and reused.

- **Typical inputs**: specs, drawings, schedules, calculations, prior
  bids, standards, addenda
- **Typical outputs**: extracted requirements, entities and
  relationships, structured document metadata, evidence links
