...
This is the **EKG Catalog** - a catalog and repository for components
of the Enterprise Knowledge Graph. It uses MkDocs with the Material
theme to generate a documentation site.
...
- **docs/use-case/** - Use case documentation with frontmatter
- **docs/diagrams/** - PlantUML diagrams
- **docs/main.py** - MkDocs hook for use case processing
